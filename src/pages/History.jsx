...
const History = () => {
  const [historyData] = useState(() => {
    ...
    const defaultData = {
      weekly: {
        ...
        values: [8.5, 9.2, 10.1, 7.8],
      },
      monthly: {
        labels: ['Jan', 'Fév', 'Mar', 'Avr', 'Mai', 'Jun'],
        values: [42, 38, 45, 52, 48, 50],
      },
      daily: [],
    };
  ...
  const [stats] = useState(() => {
    ...
    const average =
      dailyData.reduce((sum, day) => sum + day.consumption, 0) /
      dailyData.length;
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-4 rounded-lg border border-blue-200">
            ...
            <p className="text-3xl font-bold text-blue-600">
              {stats.average} <span className="text-lg">Go/jour</span>
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-red-50 to-red-100 p-4 rounded-lg border border-red-200">
            ...
            <p className="text-3xl font-bold text-red-600">
              {stats.overLimitDays} <span className="text-lg">jours</span>
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-purple-50 to-purple-100 p-4 rounded-lg border border-purple-200">
            ...
            <p className="text-3xl font-bold text-purple-600">
              {stats.totalConsumption} <span className="text-lg">Go</span>
            </p>
          </div>
        </div>
      </div>
